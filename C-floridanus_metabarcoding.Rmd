...
png("R_images/haplotype_network_publication.png", width = 6000, height = 4000, units = "px", res = 300)
plot(net_cfcp2, size = attr(net_cfcp2, "freq"), show.mutation=1, scale.ratio=0.5, cex=1.2, label=F, pie=ind_cfcp2)
legend("topleft", colnames(ind_cfcp2), col=rainbow(ncol(ind_cfcp2)), pch=19, ncol=1)
dev.off()
```
