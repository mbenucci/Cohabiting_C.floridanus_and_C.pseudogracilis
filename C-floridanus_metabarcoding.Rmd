...
#(colSums(pos.may)-colSums(pos.may[c("Osmia_bicornis","Hymenoptera"),]))/rowsumS(may.clean[,!c(colnames(may.clean) %in% c("site","sample_type","sample_id","time","predator_id"))])
#(colSums(pos.oct)-colSums(pos.oct[c("Osmia_bicornis","Hymenoptera"),]))/rowSums(oct.clean[,!c(colnames(oct.clean) %in% c("site","sample_type","sample_id","time","predator_id"))])
```
