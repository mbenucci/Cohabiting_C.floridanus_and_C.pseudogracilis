...
Note: having multiple LaTex version installed on the same machine can give errors.

```{r sanger alignment}
# Import of sanger sequences
seq=readDNAMultipleAlignment("C.floridanus_confirmation/Crangonyx_barcoding/c.flor-c.pse_full_SANGER.fasta")

msaCheckNames(seq, ".")

print(seq, show="alignment", showNames=T, order="align")
rownames(seq) = gsub("_C_", "_C.", rownames(seq))

msaPrettyPrint(seq, output="pdf",
               showConsensus="none",
               consensusThreshold = 40,
               showNames="left",
               showLogo="top",
               showLegend=T,
               paperWidth = 21, paperHeight = 12,
