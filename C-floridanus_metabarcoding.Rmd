...
Calculating read depth threshold
...
The coverage filter (based on `mean(sample_DNA_reads)-sd(sample_DNA_reads)`) for the sequencing from May 2017 results negative. We then decided to use a standard 1000 reads as coverage filter, which is very similar to the coverage calculated for the sequencing from October 2017 (1185 reads). 
