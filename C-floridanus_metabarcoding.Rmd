...
abund.guts.site[grep("Crangonyx_pseudogracilis", abund.guts.site$predator_id),"predator_id"] <- "C.pseud"

abund.guts[grep("Crangonyx_floridanus", abund.guts$predator_id),"predator_id"] <- "C.flor"
abund.guts[grep("Crangonyx_pseudogracilis", abund.guts$predator_id),"predator_id"] <- "C.pseud"
...
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseud" & fact_time.guts[,1]=="May"),col="black", pch=17)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseud" & fact_time.guts[,1]=="Oct"),col="black", pch=24)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.flor" & fact_time.guts[,1]=="May"),col="blue", pch=15)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.flor" & fact_time.guts[,1]=="Oct"),col="blue", pch=22)
...
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseud" & fact_time.guts[,1]=="May"),col="black",pch=17,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseud" & fact_time.guts[,1]=="Oct"),col="black",pch=24,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.flor" & fact_time.guts[,1]=="May"),col="black",pch=15,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.flor" & fact_time.guts[,1]=="Oct"),col="black",pch=22,cex=2)
...
kick = melt.kick[melt.kick$order == "Amphipoda",] %>% 
  ...
  coord_flip() +
  facet_grid(time~., scales="free_x") +
  labs(x="", y="Abundance (count)", title="Amphipods composition") +
