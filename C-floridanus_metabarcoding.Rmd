...
_Gammarus_zaddachi_ was present in the dataset of May with only few reads, again we suspect these might come from external contamination sources.
...
may.clean$Dikerogammarus_villosus

may.clean = may.clean[,!c(colnames(may.clean) %in% "Dikerogammarus_villosus")]

may.clean[41,]
may.clean$Gammarus_zaddachi
```
