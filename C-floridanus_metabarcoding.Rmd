...
(colSums(pos.may)-colSums(pos.may[c("Osmia_bicornis","Hymenoptera"),]))/sum(may.clean[,!c(colnames(may.clean) %in% c("site","sample_type","sample_id","time","predator_id"))])
(colSums(pos.oct)-colSums(pos.oct[c("Osmia_bicornis","Hymenoptera"),]))/sum(oct.clean[,!c(colnames(oct.clean) %in% c("site","sample_type","sample_id","time","predator_id"))])
```
...
thres.may =  0.00015 #0.00031
thres.oct =  0.000393#0.0039
```
...
```{r plot order}
col.network=c("red","red","red","red","khaki3","khaki3","cyan3","yellow","tan4","tan4","darkorchid3","cyan3","tan4","cyan3")
```

```{r legend order}
name.legend=c("C.multisetosum","Crangonyx","C.floridanus","C.pseudogracilis","C.brevilabris","D.brachyurum","S.crystallina","Cyclops","C.abyssorum","E.albipennis","P.antipodarum","L.hoffmeisteri","L.variegatus","T.tubifex")

col.legend=c("red","red","red","red","cyan3","cyan3","cyan3","khaki3","khaki3","yellow","darkorchid3","tan4","tan4","tan4")
```
