...
a = guts.melt %>% mutate(order=factor(order, levels=c("Crangonyctidae", "Corophiida", "Cladocera", "Cyclopoida", "Diptera", "Mollusca", "Oligochaeta", "Tricladida"))) %>% ggplot(aes(predator_id, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_fill_manual(values=cols_barplot, name = "") +
  theme_bw() +
  coord_flip() +
