...
cols_barplot = c("blue","darkorange","cyan3","greenyellow","yellow","deeppink","plum2","grey50","darkgreen","red","purple","aquamarine","green3","khaki4","brown","gainsboro","black")
...
guts.melt=occup.melt[occup.melt$sample_type=="guts",]

# Remove sample with value = 0
guts.melt = guts.melt[,][guts.melt$value > 0,]
...
guts.melt %>% mutate(order=factor(order, levels=c("Crangonyctidae", "Corophiida", "Cladocera", "Cyclopoida", "Diptera", "Mollusca", "Oligochaeta", "Tricladida"))) %>% ggplot(aes(predator_id, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_fill_manual(values=cols_barplot, name = "") +
  theme_bw() +
  coord_flip() +
...
tot = ggplot(occup.melt, aes(site, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_fill_manual(values=cols_barplot, name = "") +
...
guts = guts.melt %>% mutate(order=factor(order, levels=c("Crangonyctidae", "Corophiida", "Cladocera", "Cyclopoida", "Diptera", "Mollusca", "Oligochaeta", "Tricladida"))) %>% ggplot(aes(site, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
