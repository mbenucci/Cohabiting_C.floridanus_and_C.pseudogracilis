...
abund.guts.site[grep("Crangonyx_floridanus", abund.guts.site$predator_id),"predator_id"] <- "C.floridanus"
abund.guts.site[grep("Crangonyx_pseudogracilis", abund.guts.site$predator_id),"predator_id"] <- "C.pseudogracilis"

abund.guts[grep("Crangonyx_floridanus", abund.guts$predator_id),"predator_id"] <- "C.floridanus"
abund.guts[grep("Crangonyx_pseudogracilis", abund.guts$predator_id),"predator_id"] <- "C.pseudogracilis"
...
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseudogracilis" & fact_time.guts[,1]=="May"),col="black", pch=17)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseudogracilis" & fact_time.guts[,1]=="Oct"),col="black", pch=24)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.floridanus" & fact_time.guts[,1]=="May"),col="blue", pch=15)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.floridanus" & fact_time.guts[,1]=="Oct"),col="blue", pch=22)
...
png("R_images/NMDS_guts_publication.png", width = 4000, height = 4000, units = "px", res = 300)
...
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseudogracilis" & fact_time.guts[,1]=="May"),col="black",pch=17,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.pseudogracilis" & fact_time.guts[,1]=="Oct"),col="black",pch=24,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.floridanus" & fact_time.guts[,1]=="May"),col="black",pch=15,cex=2)
points(meta.guts, select=which(fact_predator.guts[,1]=="C.floridanus" & fact_time.guts[,1]=="Oct"),col="black",pch=22,cex=2)
ordispider(meta.guts,group=fact_predator.guts[,1],col=c("red","orange"),label=F,cex=2)
ordiellipse(meta.guts,group=fact_predator.guts[,1],kind="ehull",lty=c(1,5),label=F,lwd=1)
text(1.1,-1,label=paste0("Stress: ",round(meta.guts$stress,4)),cex=1.5)
text(0.7,1.3,label="C.pseudogracilis",cex=1.5)
text(-0.7,0.3,label="C.floridanus",cex=1.5)
text(-0.9,2,label="a)",cex=3)
text(0.2,2,label="gut contents",cex=2.5)
...
ordiellipse(meta.full, group=fact_type.full[,1],kind="ehull",lty=c(1,5,3),label=F,lwd=1)
text(0.4,-0.7,label=paste0("Stress: ",round(meta.full$stress,4)),cex=1.5)
text(1.1,-1.45,label=paste0("Stress: ",round(meta.guts$stress,4)),cex=1.5)
text(0,-0.35,label="kick",cex=2.5)
text(0.45,0.35,label="eDNA",cex=2.5)
text(-0.4,0.35,label="gut contents",cex=2.5)
text(-0.55,0.7,label="b)",cex=3)
