...
cols_barplot = c("red","darkorange", "cyan3", "greenyellow", "plum2", "deeppink", "yellow", "grey50",  "green","blue","palevioletred","aquamarine","goldenrod","khaki4","brown","gainsboro","tan4")
#, "","","black","darkgreen","khaki3",)
...
melt.kick[melt.kick$order == "Amphipoda",] %>% 
  ...
  scale_fill_manual(values = col_crustacea, name = "", labels=c("Corophium","Crangonyx sp.","C.floridanus","C.pseudogracilis")) +
  theme_bw() +
...
a = ggplot(occup.melt, aes(sample_type, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_fill_manual(values=cols_barplot, name = "") +
  scale_x_discrete(limits=c("kick","eDNA","guts")) +
  theme_bw() +
  ...
  theme(legend.position = "right", axis.text = element_text(size = 15), 
        ...
        legend.text = element_text(size=15), plot.margin=unit(c(0.25,0,0.25,0.4), unit="cm"))
...
c = guts.melt %>% mutate(order=factor(order, levels=c("Crangonyctidae", "Corophiida", "Cladocera", "Cyclopoida", "Diptera", "Mollusca", "Oligochaeta", "Tricladida"))) %>% ggplot(aes(predator_id, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_fill_manual(values=cols_barplot, name = "") +
  theme_bw() +
  coord_flip() +
...
d = ggplot(melt.occup.edna, aes(site, value)) +
  geom_bar(stat="identity", position="fill", aes(fill=order)) +
  scale_x_discrete(limits=c("eCH1","eCH2","eCH3","eCH4","eCH5")) +
  coord_flip() +
  labs(y="Community composition (%)", x="") +
...
ga = plot_grid(a, labels=c("a)"), label_size=25, label_fontface=1)
gb = plot_grid(b, labels=c("b)"), label_size=25, label_fontface=1)
gc = plot_grid(c, labels=c("c)"), label_size=25, label_fontface=1)
gd = plot_grid(d, labels=c("d)"), label_size=25, label_fontface=1)

png("R_images/barplot_community_pubblication.png", width = 4000, height = 4000, units = "px", res = 310)
grid.arrange(ga, gb, ncol=1, nrow=4) #layout_matrix=lay)
#plot_grid(a, b, c, d, labels=c("a)","b)","c)","d)"), ncol=3, label_size=25, label_fontface=1)
dev.off()
```
