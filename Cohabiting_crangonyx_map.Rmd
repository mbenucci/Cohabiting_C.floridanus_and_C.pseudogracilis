...
Removing few objects to avoid memory issues on my machine.

```{r removing}
rm(bo,ch,ky,na,th,up)
```
...
uk = ggplot(uk_map) +
  geom_polygon(aes(long,lat,group = group), fill="white", color="black") +
  geom_rect(data=detect.sites[detect.sites$Label == "Bourn",], aes(xmin=390000, xmax=420000, ymin=80000, ymax=100000), color="red", fill="transparent", cex=1) +
  geom_rect(data=detect.sites[detect.sites$Label == "Chase",], aes(xmin=400000, xmax=410000, ymin=300000, ymax=310000), color="red", fill="transparent", cex=1) +
  geom_rect(data=detect.sites[detect.sites$Label == "Kyngs",], aes(xmin=500000, xmax=560000, ymin=270000, ymax=330000), color="red", fill="transparent", cex=1) +
  geom_rect(data=detect.sites[detect.sites$Label == "Nar",], aes(xmin=560000, xmax=590000, ymin=300000, ymax=325000), color="red", fill="transparent", cex=1) +
  geom_rect(data=detect.sites[detect.sites$Label == "Thwai",], aes(xmin=470000, xmax=540000, ymin=410000, ymax=450000), color="red", fill="transparent", cex=1) +
  geom_rect(data=detect.sites[detect.sites$Label == "Upton",], aes(xmin=630000, xmax=660000, ymin=300000, ymax=320000), color="red", fill="transparent", cex=1) +
  geom_text(data=detect.sites[detect.sites$Label == "Bourn",], aes(X, Y, label="2"), nudge_y=-50000, cex=4) +
  geom_text(data=detect.sites[detect.sites$Label == "Chase",], aes(X,Y, label="1"), nudge_x=-30000, cex=4) +
  geom_text(data=detect.sites[detect.sites$Label == "Kyngs",], aes(X,Y, label="3"), nudge_y=-60000, cex=4) +
  geom_text(data=detect.sites[detect.sites$Label == "Nar",], aes(X,Y, label="4"), nudge_x=10000, nudge_y=-40000, cex=4) +
  geom_text(data=detect.sites[detect.sites$Label == "Thwai",], aes(X,Y, label="5"), nudge_x=70000, cex=4) +
  geom_text(data=detect.sites[detect.sites$Label == "Upton",], aes(X,Y, label="6"), nudge_x=50000, cex=4) +
  coord_fixed(1) +
  theme_void() +
...
bo = ggplot(bo_map) +
  ...
  geom_label(data=detect.sites[detect.sites$Label == "Bourn",], aes(x=390000, y=110000, label="2."), cex=6) +
  coord_fixed(ratio=1, xlim=c(390000,420000), ylim=c(80000,110000)) +
  theme_void() +
...
ch = ggplot(ch_map) +
  ...
  geom_label(data=detect.sites[detect.sites$Label == "Chase",], aes(x=402500, y=308900, label="1."), cex=6) +
...
ky = ggplot(ky_map) +
  geom_polygon(aes(long,lat,group = group), fill="grey90", color="black") +
  geom_polygon(data=na_map, aes(long,lat, group=group), fill="grey90", color="black") +
  geom_rect(aes(xmin=500000, xmax=525000, ymin=269000, ymax=275000), color="white", fill="white") +
  geom_point(data=detect.sites[detect.sites$Label == "Kyngs",], aes(X, Y), color="red", cex=3) +
  geom_label(data=detect.sites[detect.sites$Label == "Kyngs",], aes(X, Y, label=Description), nudge_y=-3000, cex=4) +
  geom_label(data=detect.sites[detect.sites$Label == "Kyngs",], aes(x=500000, y=330000, label="3."), cex=6) +
  coord_fixed(ratio=1, xlim=c(500000,560000), ylim=c(270000,330000)) +
  theme_void() +
  theme(plot.margin=unit(c(t=0.25, r=0.25, b=0.25, l=0), unit="cm"), panel.border=element_rect(color="black", fill=NA, size=2)) +
  ggsn::scalebar(location="bottomleft", x.min=500000, x.max=510000, y.min=271000, y.max=272000, dist=10000, dist_unit="m", st.dist=2, height=2, transform=F)

na = ggplot(na_map) +
  geom_polygon(aes(long,lat,group = group), fill="grey90", color="black") +
  geom_point(data=detect.sites[detect.sites$Label == "Nar",], aes(X, Y), color="red", cex=3) +
  geom_label(data=detect.sites[detect.sites$Label == "Nar",], aes(X, Y, label=Description), nudge_x=0, nudge_y=2000, cex=4) +
  geom_label(data=detect.sites[detect.sites$Label == "Nar",], aes(x=560000, y=330000, label="4."), cex=6) +
  ...
  ggsn::scalebar(location="bottomleft", x.min=560000, x.max=565000, y.min=300500, y.max=301000, dist=5000, dist_unit="m", st.dist=1, height=2, transform=F)
...
th = ggplot(th_map) +
  ...
  geom_label(data=detect.sites[detect.sites$Label == "Thwai",], aes(x=470000,y=470000, label="5."), cex=6) +
  coord_fixed(ratio=1, xlim=c(470000,540000), ylim=c(410000,470000)) +
  theme_void() +
...
up = ggplot(up_map) +
  ...
  geom_label(data=detect.sites[detect.sites$Label == "Upton",], aes(x=630000, y=330000, label="6."), cex=6) +
  coord_fixed(ratio=1, xlim=c(630000,660000), ylim=c(300000,330000)) +
  theme_void() +
